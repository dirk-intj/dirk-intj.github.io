...
export default {
  ...
  components: {
    ...
    footer: {
      createdWith: "<b>Возрастная категория: 18+</b> (Запрещено для детей в соответствии с Федеральным законом № 436-ФЗ). Все материалы данного ресурса являются некоммерческим литературным творчеством и художественным вымыслом автора и предназначены исключительно для совершеннолетней аудитории.<br> © Hiddenheið, Dirk.Intj, 2026–${new Date().getFullYear()}. Все права защищены.",
    },
    graph: {
      title: "Граф",
    },
